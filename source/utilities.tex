...
\begin{itemize}
\item
Let \tcode{I} be a pack formed by the sequence of \tcode{size_t\{$i$\}}
for every integer $0 \leq i < \tcode{tuple_size_v<remove_reference_t<Tuple>>}$.
\tcode{is_constructible_v<T, decltype(get<I>(declval<Tuple>()))...>} is \tcode{true}, and
\item
