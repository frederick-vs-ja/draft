...
\pnum
After substitution of explicitly specified template argument values is performed,
...
\pnum
The function type after substitution of explicitly specified template
arguments with their corresponding template parameters and adjustment
is used for template argument
...
or default template arguments
are substituted for their corresponding template parameters.
...
to take a function type that makes use of template parameters and substitute those
template parameters with the corresponding template arguments. Substitution is done at
...
\end{itemize}
Substitution of template argument values for the corresponding template
parameters occurs in all types and expressions that are used
...
expressions. Substitution proceeds in lexical order and stops when
